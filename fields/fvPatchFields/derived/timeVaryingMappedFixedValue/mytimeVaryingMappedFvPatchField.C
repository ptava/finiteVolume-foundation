...
#include "mytimeVaryingMappedFvPatchField.H"
#include "Time.H"
...
template<class Type>
Foam::fileName
Foam::mytimeVaryingMappedFvPatchField<Type>::findFieldFile
(
    const word& timeName
) const
{
...
template<class Type>
void Foam::mytimeVaryingMappedFvPatchField<Type>::checkTable()
{
    // Initialise
    if (mapperPtr_.empty())
    {
        ...
        if (debug)
        {
            Info<< "mytimeVaryingMappedFvPatchField :"
        ...
        if (debug)
        {
            Info<< "mytimeVaryingMappedFvPatchField : In directory "
...
template<class Type>
Foam::mytimeVaryingMappedFvPatchField<Type>::
mytimeVaryingMappedFvPatchField
(
...
template<class Type>
void Foam::mytimeVaryingMappedFvPatchField<Type>::map
(
    const mytimeVaryingMappedFvPatchField<Type>& tiptf,
    const fieldMapper& mapper
)
{
    reset(tiptf);
...
template<class Type>
void Foam::mytimeVaryingMappedFvPatchField<Type>::reset
(
    const mytimeVaryingMappedFvPatchField<Type>& tiptf
)
{
...
template<class Type>
Foam::tmp<Foam::Field<Type>> Foam::mytimeVaryingMappedFvPatchField<Type>::map()
{
    checkTable();
...
template<class Type>
void Foam::mytimeVaryingMappedFvPatchField<Type>::write
(
    Ostream& os
) const
{
