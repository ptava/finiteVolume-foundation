...
template<class Type>
Foam::mytimeVaryingMappedFixedValueFvPatchField<Type>::
...
template<class Type>
void Foam::mytimeVaryingMappedFixedValueFvPatchField<Type>::map
(
...
template<class Type>
void Foam::mytimeVaryingMappedFixedValueFvPatchField<Type>::reset
(
    const fvPatchField<Type>& ptf
)
{
...
template<class Type>
void Foam::mytimeVaryingMappedFixedValueFvPatchField<Type>::updateCoeffs()
{
    if (this->updated())
    {
        return;
...
template<class Type>
void Foam::mytimeVaryingMappedFixedValueFvPatchField<Type>::write
(
    Ostream& os
) const
{
